    ...
    public partial class AP_ProductPlan : DC00_WinForm.BaseMDIChildForm
    {
        ...
        private void DoFind()
        {
            ...
            try
            {
                ...
                string sWorkecenterCode = Convert.ToString(cboWorkcenterCode_H.Value);
                string sorderno         = Convert.ToString(txtOrderNo.Text);
                string sOrderCloseFlag  = Convert.ToString(cboOrderCloseFlag.Value);

                rtnDtTemp = helper.FillTable("11AP_ProductPlan_S1", CommandType.StoredProcedure
                ...
                foreach (DataRow drRow in dtTemp.Rows)
                {
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            #region 삭제
                            drRow.RejectChanges();
                            helper.ExecuteNoneQuery("11AP_ProductPlan_D1", CommandType.StoredProcedure
                        ...
                        case DataRowState.Added:
                            ...
                            helper.ExecuteNoneQuery("11AP_ProductPlan_I1", CommandType.StoredProcedure
                        ...
                        case DataRowState.Modified:
                            ...
                            helper.ExecuteNoneQuery("11AP_ProductPlan_U1", CommandType.StoredProcedure
                                                  , helper.CreateParameter("PLANTCODE", drRow["PLANTCODE"].ToString(), DbType.String, ParameterDirection.Input)
